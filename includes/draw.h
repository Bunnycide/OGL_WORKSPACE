...
public:
    ...
    void initDraw(){              
        ...
        shader->setInt(2, "material.glow");
        shader->setFloat(0.78125f, "material.shininess");

        shader->setVec3(glm::vec3(1.2f, 1.0f, 2.0f), "light.position");
        shader->setVec3(glm::vec3(0.2f, 0.2f, 0.2f), "light.ambient");
        shader->setVec3(glm::vec3(0.5f, 0.5f, 0.5f), "light.diffuse");
        shader->setVec3(glm::vec3(0.8f, 0.8f, 0.8f), "light.specular");
